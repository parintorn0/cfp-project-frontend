...
{#each $liabilities as liability, index}
    <div class="container">
            ...
            <div class="input-col">
                <div class="input-row">
                    <div class="input-field">
                        ชื่อ <input type="text" bind:value={liability.name}>
                    </div>
                </div>
                <div class="input-row">
                    <div class="input-field">
                        วันที่เริ่มต้นกู้ <input type="date" bind:value={liability.start}>
                    </div>
                </div>
                <div class="input-row">
                    <div class="input-field">
                        วันที่สิ้นสุด <input type="date" bind:value={liability.end}>
                    </div>
                </div>
            </div>
            <div class="input-col">
                <div class="input-row">
                    <div class="input-field">
                        เงินต้น
                        <input type="text" bind:value={liability.amount}>
                    </div>
                ...
                <div class="input-row">
                    <div class="input-row">
                        <div class="input-field">
                            อัตราดอกเบี้ยต่อปี <input type="text" bind:value={liability.rate}>
                        </div>
                        <div class="red">ใส่เป็นตัวเลข</div>
                    </div>
                </div>
        ...
        <div class="btn-container">
            <div class="btn">
                <Button style="display: flex; align-items: center; font-size: 16px;" color={{"r": 255, "g": 0, "b": 0, "a": 0.3}} onClick={()=>removeLiability(index)}>
