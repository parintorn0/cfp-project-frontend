<script>
    ...
    onMount(()=>{
        if (type === "Salary") {
            thaiType = "รายได้ประจำ"
        }
        else if (type === "Investment") {
            thaiType = "รายได้จากการลงทุน"
        }
        else if (type === "Other") {
            thaiType = "รายได้เสริม (เฉพาะที่ไม่มีความถี่ คาดการไม่ได้)"
        }
    })
    function addIncome(){
    ...
    {#if income.type === type}
        <div class="container">
            <div>
                <div class="input-col">
                    <div class="input-row">
                        <div class="input-field">
                            ชื่อ <input type="text" bind:value={income.name}>
                        </div>
                    </div>
                    <div class="input-row">
                        <div class="input-field">
                            จำนวนเงินต่อปี
                            <input type="text" bind:value={income.amount}>
                        </div>
                ...
                <div class="input-col">
                    <div class="input-row">
                        <div class="input-field">
                            อัตราการเติบโตต่อปี
                            <input type="text" bind:value={income.growthrate}>
                        </div>
                        <div class="red">ใส่เป็นตัวเลข</div>
                    </div>
                </div>
            ...
            <div class="btn-container">
                <div class="btn">
                    <Button style="display: flex; align-items: center; font-size: 16px;" color={{"r": 255, "g": 0, "b": 0, "a": 0.3}} onClick={()=>removeIncome(index)}>
