<script>
    ...
    import {cfpCustomerList} from "$lib/Admin/store.js";
...
<Title>{$cfpCustomerList.cfp_name}</Title>
...
<table>
    ...
    <tbody>
    {#each $cfpCustomerList['customer'] as data, index}
        <tr>
            ...
            <td>
                <div class="status-container">
                    <div class="edit-view">
                        {#each data.versions_info as version_info}
                            {#if selected[index] && version_info.version_num===selected[index]}
                                <button on:click={()=>{window.location.href='/cfp/assets/'+version_info.version_id}}>
